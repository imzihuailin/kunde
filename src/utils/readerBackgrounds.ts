...
const BACKGROUND_MAP: Record<ReaderColorId, Record<ReaderBackgroundVariantId, ReaderBackground>> = {
  white: {
    pure: { id: 'white-pure', colorId: 'white', backgroundVariantId: 'pure', image: createAssetPath('white-pure.jpg'), textColor: '#1f2937', linkColor: '#2563eb', surfaceOverlay: '#ffffff', borderColor: 'rgba(82,97,122,0.18)', isDarkScheme: false, fallbackColor: '#f8fbff', pageScrim: 'rgba(255,255,255,0.08)', previewPosition: 'center center', pagePosition: 'center top' },
    moon: { id: 'white-moon', colorId: 'white', backgroundVariantId: 'moon', image: createAssetPath('white-moon.jpg'), textColor: '#1e293b', linkColor: '#2563eb', surfaceOverlay: '#ffffff', borderColor: 'rgba(82,97,122,0.18)', isDarkScheme: false, fallbackColor: '#dfeeff', pageScrim: 'rgba(255,255,255,0.08)', previewPosition: 'center top', pagePosition: 'center top' },
    scene: { id: 'white-scene', colorId: 'white', backgroundVariantId: 'scene', image: createAssetPath('white-scene.jpg'), textColor: '#1e293b', linkColor: '#2563eb', surfaceOverlay: '#ffffff', borderColor: 'rgba(82,97,122,0.18)', isDarkScheme: false, fallbackColor: '#dbeafe', pageScrim: 'rgba(255,255,255,0.08)', previewPosition: 'center top', pagePosition: 'center bottom' },
  },
  yellow: {
    pure: { id: 'yellow-pure', colorId: 'yellow', backgroundVariantId: 'pure', image: createAssetPath('yellow-pure.jpg'), textColor: '#5f4523', linkColor: '#b45309', surfaceOverlay: '#fff7e8', borderColor: 'rgba(169,113,42,0.2)', isDarkScheme: false, fallbackColor: '#f8ead7', pageScrim: 'rgba(255,248,240,0.08)', previewPosition: 'center center', pagePosition: 'center top' },
    moon: { id: 'yellow-moon', colorId: 'yellow', backgroundVariantId: 'moon', image: createAssetPath('yellow-moon.jpg'), textColor: '#5f4523', linkColor: '#c26d12', surfaceOverlay: '#fff5eb', borderColor: 'rgba(169,113,42,0.2)', isDarkScheme: false, fallbackColor: '#f6eadf', pageScrim: 'rgba(255,244,236,0.08)', previewPosition: 'center top', pagePosition: 'center top' },
    scene: { id: 'yellow-scene', colorId: 'yellow', backgroundVariantId: 'scene', image: createAssetPath('yellow-scene.jpg'), textColor: '#5f4523', linkColor: '#b45309', surfaceOverlay: '#fff6e8', borderColor: 'rgba(169,113,42,0.2)', isDarkScheme: false, fallbackColor: '#f7e7d5', pageScrim: 'rgba(255,244,236,0.08)', previewPosition: 'center top', pagePosition: 'center bottom' },
  },
  green: {
    pure: { id: 'green-pure', colorId: 'green', backgroundVariantId: 'pure', image: createAssetPath('green-pure.jpg'), textColor: '#1c4d2c', linkColor: '#15803d', surfaceOverlay: '#f0fff0', borderColor: 'rgba(32,104,52,0.2)', isDarkScheme: false, fallbackColor: '#dbf4d5', pageScrim: 'rgba(248,255,248,0.08)', previewPosition: 'center center', pagePosition: 'center top' },
    moon: { id: 'green-moon', colorId: 'green', backgroundVariantId: 'moon', image: createAssetPath('green-moon.jpg'), textColor: '#18442f', linkColor: '#0f8b8d', surfaceOverlay: '#f1fff3', borderColor: 'rgba(32,104,52,0.2)', isDarkScheme: false, fallbackColor: '#d8f9d4', pageScrim: 'rgba(250,255,250,0.08)', previewPosition: 'center top', pagePosition: 'center top' },
